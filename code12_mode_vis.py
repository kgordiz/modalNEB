...
def VESTA_out_POSCAR_sortedEn(dx, x_coords, filename_POSCAR_original, compound_name, w, v, En):
    ...
    filename1 = 'mode_vis_sorted_based_on_En/'
    filepath1 = "./" + filename1
    #try:
...
def VESTA_out_POSCAR_unsorted(x_coords, filename_POSCAR_original, compound_name, w, v):
    # Some initital parameters
    scale = 8
    radius = 0.25
    RGB = "255 0 0"
