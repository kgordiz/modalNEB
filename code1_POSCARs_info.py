...
class POSCARs_info:
    ...
    def read_masses_and_xyzs(self):
        filename = self.path_NEB + "0" + str(self.idx1) + "/POSCAR"
        if exists(filename) == False:
            filename = self.path_NEB + "0" + str(self.idx1) + "/CONTCAR"
        ...
        filename = self.path_NEB + "0" + str(self.idx2) + "/POSCAR"
        if exists(filename) == False:
            filename = self.path_NEB + "0" + str(self.idx2) + "/CONTCAR"
        ...
        # Just read the coordinates
        filename = self.path_NEB + "0" + str(self.idx3) + "/POSCAR"
        if exists(filename) == False:
            filename = self.path_NEB + "0" + str(self.idx2) + "/CONTCAR"
