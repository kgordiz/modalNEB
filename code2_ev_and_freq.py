...
class ev_freq_info:
    ...
    def perform_LD(self): # Function to calculate frequencies and eigenvectors
...
class phononBC:
    ...
    def partialDOS(self, val1): # Function to calculate partial phonon BCs
